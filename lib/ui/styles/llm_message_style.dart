...
class LlmMessageStyle {
  ...
  factory LlmMessageStyle.defaultStyle({ToolkitTextStyles? textStyles}) =>
      LlmMessageStyle._lightStyle(textStyles ?? ToolkitTextStyles.fallback());

  /// Provides a default light style.
  factory LlmMessageStyle._lightStyle(ToolkitTextStyles textStyles) =>
      LlmMessageStyle(
