...
class SuggestionStyle {
  ...
  factory SuggestionStyle.defaultStyle({ToolkitTextStyles? textStyles}) =>
      SuggestionStyle._lightStyle(textStyles ?? ToolkitTextStyles.fallback());

  /// Provides a default light style.
  ///
  /// This style is typically used for suggestions in light mode.
  factory SuggestionStyle._lightStyle(ToolkitTextStyles textStyles) =>
      SuggestionStyle(
