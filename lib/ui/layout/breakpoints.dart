...
extension AdaptiveTextScale on BuildContext {
  ...
  double scaleFont(double baseSize) {
    return (baseSize + 1.0) * textScaleFactor;
  }
}

TextTheme scaleTextTheme(TextTheme baseTheme, double factor, double delta) {
  double scale(double? base, double def) {
    return ((base ?? def) + delta) * factor;
  }

  return baseTheme.copyWith(
    displayLarge: baseTheme.displayLarge?.copyWith(
      fontSize: scale(baseTheme.displayLarge?.fontSize, 57.0),
    ),
    displayMedium: baseTheme.displayMedium?.copyWith(
      fontSize: scale(baseTheme.displayMedium?.fontSize, 45.0),
    ),
    displaySmall: baseTheme.displaySmall?.copyWith(
      fontSize: scale(baseTheme.displaySmall?.fontSize, 36.0),
    ),
    headlineLarge: baseTheme.headlineLarge?.copyWith(
      fontSize: scale(baseTheme.headlineLarge?.fontSize, 32.0),
    ),
    headlineMedium: baseTheme.headlineMedium?.copyWith(
      fontSize: scale(baseTheme.headlineMedium?.fontSize, 28.0),
    ),
    headlineSmall: baseTheme.headlineSmall?.copyWith(
      fontSize: scale(baseTheme.headlineSmall?.fontSize, 24.0),
    ),
    titleLarge: baseTheme.titleLarge?.copyWith(
      fontSize: scale(baseTheme.titleLarge?.fontSize, 22.0),
    ),
    titleMedium: baseTheme.titleMedium?.copyWith(
      fontSize: scale(baseTheme.titleMedium?.fontSize, 16.0),
    ),
    titleSmall: baseTheme.titleSmall?.copyWith(
      fontSize: scale(baseTheme.titleSmall?.fontSize, 14.0),
    ),
    bodyLarge: baseTheme.bodyLarge?.copyWith(
      fontSize: scale(baseTheme.bodyLarge?.fontSize, 16.0),
    ),
    bodyMedium: baseTheme.bodyMedium?.copyWith(
      fontSize: scale(baseTheme.bodyMedium?.fontSize, 14.0),
    ),
    bodySmall: baseTheme.bodySmall?.copyWith(
      fontSize: scale(baseTheme.bodySmall?.fontSize, 12.0),
    ),
    labelLarge: baseTheme.labelLarge?.copyWith(
      fontSize: scale(baseTheme.labelLarge?.fontSize, 14.0),
    ),
    labelMedium: baseTheme.labelMedium?.copyWith(
      fontSize: scale(baseTheme.labelMedium?.fontSize, 12.0),
    ),
    labelSmall: baseTheme.labelSmall?.copyWith(
      fontSize: scale(baseTheme.labelSmall?.fontSize, 11.0),
    ),
  );
}
