...
/// The compact-width navigation drawer: the product mark, then the top-level
/// destinations directly beneath it.
///
/// The destinations sit at the top, where a navigation drawer's menu is
/// expected to be, rather than at the bottom of the panel: a three-item menu
/// pushed to the far edge reads as an afterthought, and the drawer is opened
/// deliberately from a hamburger rather than swiped at one-handed.
///
...
/// A stadium-shaped destination tile for the drawer menu, matching the
/// conversation tiles elsewhere in the app.
